...
public class PassengerQueue {
    ...
    /**
     * Construct a PassengerQueue with the given name and
     * a pre-defined sequence of arrival times.
     * @param queueName The name of this queue
     * @param arrivalTimes A Queue<int[]> of arrival and processing times
     */
